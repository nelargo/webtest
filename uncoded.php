...
<body>
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="http://madgoatstd.com/FPex/uncoded.php">Uncoded key</a></li>
  ...
  <script>
    ...
    function post(){
      var defautl_print_raw = fp1.getStr();
      var resolution_print_raw= fp3.getStr();
      var canvas_print_raw= fp2.getStr();

      $.post('think.php',{default_raw:defautl_print_raw,resolution_raw:resolution_print_raw,canvas_raw:canvas_print_raw},
          function(data){
            $('#target').html(data);
          }
        );
